...
bench(SpectralClustering(n_clusters=4,assign_labels="discretize",random_state=0,
                             affinity="nearest_neighbors"),name="SpectralClustering",data=data)

bench(AgglomerativeClustering(linkage="ward", n_clusters=4),name="WardHierarchical",data=data)

bench(AgglomerativeClustering(n_clusters=4),name="AgglomerativeClustering",data=data)
